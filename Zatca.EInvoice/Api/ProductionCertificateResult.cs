...
{
    /// <summary>
    /// Holds the production certificate response data from ZATCA API.
    /// </summary>
    public sealed class ProductionCertificateResult
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductionCertificateResult"/> class.
        /// </summary>
        /// <param name="binarySecurityToken">The certificate.</param>
        /// <param name="secret">The secret key.</param>
        /// <param name="requestId">The request ID.</param>
        public ProductionCertificateResult(string binarySecurityToken, string secret, string requestId)
        ...
        public ProductionCertificateResult(
